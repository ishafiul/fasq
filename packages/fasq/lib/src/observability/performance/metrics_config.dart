...
///
/// This class serves as the central point for managing a
/// list of [MetricsExporter]
...
class MetricsConfig {
  ...
  ///
  /// Each exporter will receive performance snapshots
  ///  when metrics are exported.
  /// List of configured metrics exporters.
  ///
  /// Each exporter will receive performance snapshots when
  ...
  ///
  /// Iterates through the [exporters] list
  /// and calls [MetricsExporter.configure]
