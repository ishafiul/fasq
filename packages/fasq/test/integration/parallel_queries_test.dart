...
void main() {
  group('Parallel Queries - Core Behavior', () {
    ...
    test('all queries execute independently', () async {
      ...
      final query1 =
          client.getQuery('query1'.toQueryKey(), queryFn: fetchData1);
      final query2 =
          client.getQuery('query2'.toQueryKey(), queryFn: fetchData2);
      final query3 =
          client.getQuery('query3'.toQueryKey(), queryFn: fetchData3);
    ...
    test('error in one query does not affect others', () async {
      ...
      final query1 =
          client.getQuery('success1'.toQueryKey(), queryFn: fetchSuccess);
      final query2 = client.getQuery('error'.toQueryKey(), queryFn: fetchError);
      final query3 =
          client.getQuery('success2'.toQueryKey(), queryFn: fetchSuccess2);
