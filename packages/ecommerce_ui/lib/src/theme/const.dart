...
class TextScale {
  ...
  factory TextScale.majorThird({double base = 16}) =>
      _fromRatio(1.250, base: base);

  /// Creates a text scale using Perfect Fourth ratio (1.333).
  factory TextScale.perfectFourth({double base = 16}) =>
      _fromRatio(1.333, base: base);

  /// Creates a text scale using Golden Ratio (1.618).
  factory TextScale.goldenRatio({double base = 16}) =>
      _fromRatio(1.618, base: base);
}
...
class TypographyScale {
  ...
  factory TypographyScale.majorThird({double base = 16}) =>
      _fromTextScale(TextScale.majorThird(base: base));

  /// Creates a typography scale using Perfect Fourth ratio (1.333).
  factory TypographyScale.perfectFourth({double base = 16}) =>
      _fromTextScale(TextScale.perfectFourth(base: base));

  /// Creates a typography scale using Golden Ratio (1.618).
  factory TypographyScale.goldenRatio({double base = 16}) =>
      _fromTextScale(TextScale.goldenRatio(base: base));
...
extension ContextTypography on BuildContext {
  ...
  TypographyScale get perfectFourthTypography =>
      TypographyScale.perfectFourth();
