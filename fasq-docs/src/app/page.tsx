  ...
  return (
    ...
    >
      ...
      >
        ...
        Built-in circuit breakers, isolate-powered parsing, and secure caching.
      </p>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        >
          ...
          <p>
            Inspired by TanStack Query but built for the Flutter ecosystem, Fasq
            ensures 120FPS performance by offloading heavy JSON parsing to
            background <strong>Isolates</strong> and offers{" "}
        ...
        >
          ...
          >
            ...
            <p style={{ color: "#d0d0d0" }}>
              Use Fasq with flutter_hooks for declarative data fetching. Perfect
              for functional components and modern Flutter development.
            </p>
          ...
          >
            ...
            <p style={{ color: "#d0d0d0" }}>
              Integrate Fasq with flutter_bloc for structured state management.
              Ideal for complex applications with clear separation of concerns.
            </p>
            <div style={{ marginTop: 15 }}>
              <code
                style={{
          ...
          >
            ...
            <p style={{ color: "#d0d0d0" }}>
              Leverage Fasq with flutter_riverpod for compile-safe providers and
              dependency injection. Great for scalable applications.
            </p>
            <div style={{ marginTop: 15 }}>
              <code
                style={{
          ...
          >
            ...
            <p style={{ color: "#d0d0d0" }}>
              ...
              Perfect for custom implementations and learning the fundamentals.
            </p>
            <div style={{ marginTop: 15 }}>
              <code
                style={{
        ...
        >
          ...
          >
            ...
            <p style={{ color: "#d0d0d0" }}>
              Comprehensive error handling with retry mechanisms, fallback
      ...
      data: (user) => Column(
        ...
        >
          ...
          >
            ...
            >
              ...
              FASQ provides{" "}
              <strong style={{ color: "#4ade80" }}>tactical speed</strong> with{" "}
              <strong style={{ color: "#4ade80" }}>strategic resilience</strong>
        ...
        >
          ...
          >
            ...
            <p style={{ color: "#d0d0d0" }}>
              Start with our comprehensive documentation covering core concepts,
