      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          ...
          onTap: () {
            ...
            prefetchCubit.prefetch('user-$userId', () => api.fetchUser(userId));
...
class _UserProfileState extends State<UserProfile> {
  ...
  void initState() {
    ...
    if (widget.shouldPrefetchRelated) {
      _prefetchCubit.prefetchAll([
        PrefetchConfig(key: 'user-posts-${widget.userId}', queryFn: () => api.fetchUserPosts(widget.userId)),
        PrefetchConfig(key: 'user-followers-${widget.userId}', queryFn: () => api.fetchUserFollowers(widget.userId)),
      ]);
    }
  }
...
PrefetchBuilder(
  configs: [PrefetchConfig(key: 'data', queryFn: fetchData)],
  child: MyWidget(),
);
...
class _MyWidgetState extends State<MyWidget> {
  ...
  void initState() {
    ...
    _cubit.prefetch('data', fetchData);
  }
...
_prefetchCubit.prefetch('user', () => api.fetchUser());
_prefetchCubit.prefetch('posts', () => api.fetchPosts());
```
...
class _UserCardState extends State<UserCard> {
  ...
  Widget build(BuildContext context) {
    return Card(
      child: InkWell(
        onHover: () => _prefetchCubit.prefetch('user-data', fetchUserData),
        onTap: () => _prefetchCubit.prefetch('user-details', fetchUserDetails),
