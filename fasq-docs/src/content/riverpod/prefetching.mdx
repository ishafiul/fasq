...
- **[`queryProvider`](/docs/riverpod/query-provider)** - How to consume prefetched data
- **[`infiniteQueryProvider`](/docs/riverpod/infinite-query-provider)** - Prefetching paginated lists
