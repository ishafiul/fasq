...
> [!TIP]
> We are developing the **[fasq_metrics](/docs/installation#coming-soon)** package to provide turn-key metrics exporting for Riverpod-based applications, including automated OpenTelemetry integration.
