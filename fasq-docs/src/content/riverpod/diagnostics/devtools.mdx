...
> [!TIP]
> The upcoming **Fasq DevTools Extension** will integrate natively with Riverpod, allowing you to see the relationship between your providers and the underlying query cache.
...
- [Global Observers](/docs/riverpod/advanced/configuration#global-observers)
