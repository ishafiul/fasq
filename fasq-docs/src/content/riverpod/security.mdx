...
> [!TIP]
> For enterprise-grade encryption and encrypted persistence, we recommend using the **[fasq_security](/docs/security)** package.
...
- **[`fasqClientProvider`](/docs/riverpod/advanced/configuration)** - How the client is shared
