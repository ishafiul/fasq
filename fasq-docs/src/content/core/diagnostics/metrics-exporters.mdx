...
> [!TIP]
> While Fasq provides built-in metrics support, we are developing the specialized **[fasq_metrics](/docs/installation#coming-soon)** package for standardized Prometheus and OpenTelemetry exporting with zero configuration.
