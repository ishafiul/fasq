...
- [QueryClient](/docs/core/essentials/query-client) - Learn about the QueryClient API
- [Error Handling](/docs/core/essentials/error-handling) - Error handling strategies
- [Error Tracking](/docs/core/advanced/error-tracking) - Error tracking and reporting with rich context
- [QueryClientObserver](/docs/core/essentials/query-client) - Create custom observers
