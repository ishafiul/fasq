...
> [!NOTE]
> If you are using a state management library like **Riverpod**, **Bloc**, or **Hooks**, check out our optimized [adapters](/docs/installation#state-management-adapters) for a better developer experience.
...
- **[QueryBuilder](/docs/core/essentials/query-builder)**: The main widget for fetching data.
- **[MutationBuilder](/docs/core/essentials/mutation-builder)**: Handling data updates (POST/PUT/DELETE).
- **[QueryClient](/docs/core/essentials/query-client)**: Managing the cache and global configuration.
- **[QueryOptions](/docs/core/essentials/query-options)**: Fine-tuning query behavior.
- **[Logging](/docs/core/diagnostics/logging)**: Debug and monitor queries with built-in logging.
