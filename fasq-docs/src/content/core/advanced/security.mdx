...
> [!TIP]
> While you can implement your own security plugin, we recommend using the pre-built **[fasq_security](/docs/security)** package which provides enterprise-grade AES-GCM encryption and encrypted SQLite persistence out of the box.
