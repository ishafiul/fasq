...
> [!TIP]
> To automate serializer registration for complex data types and eliminate manual boilerplate, check out the **[fasq_serializer_generator](/docs/serialization)** package.
