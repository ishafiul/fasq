...
For complete logging documentation, see [Logging](/docs/core/diagnostics/logging).
...
For complete documentation on error tracking, including PII sanitization, integration examples, and best practices, see [Error Tracking](/docs/core/advanced/error-tracking).
...
### Getting Query-Specific Metrics
...
For more details, see the [Performance Monitoring](/docs/core/advanced/performance) and [Metrics Exporters](/docs/core/advanced/metrics-exporters) documentation.
