...
*See [Infinite Queries](/docs/core/essentials/infinite-queries) for the full guide.*

### Optimistic Updates

Update the UI immediately when a user performs an action.

*See [Mutation Builder](/docs/core/essentials/mutation-builder#optimistic-updates) for the full guide.*
