      ...
      body: ListView(
        ...
        children: [
          ...
          _buildExampleCard(
            ...
            () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const DeduplicationExamplePage()),
            ),
          ),
          const SizedBox(height: 12),
          _buildExampleCard(
            ...
            () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const InvalidationExamplePage()),
            ),
          ),
          const SizedBox(height: 12),
          _buildExampleCard(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text('StaleTime: ${staleTime.inSeconds}s (data fresh for ${staleTime.inSeconds}s)'),
                Slider(
...
class InvalidationExamplePage extends StatefulWidget {
  ...
  @override
  State<InvalidationExamplePage> createState() => _InvalidationExamplePageState();
}
        ...
        child: Column(
          ...
          children: [
            ...
            Card(
              ...
              child: Padding(
                padding: const EdgeInsets.all(16),
                child: MutationBuilder<Map<String, dynamic>, Map<String, String>>(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            label: Text(state.isLoading ? 'Creating...' : 'Create User'),
                            style: ElevatedButton.styleFrom(
                              padding: const EdgeInsets.all(16),
