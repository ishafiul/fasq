...
class LoadMoreButtonScreen extends StatefulWidget {
  ...
  @override
  State<LoadMoreButtonScreen> createState() => _LoadMoreButtonScreenState();
}

class _LoadMoreButtonScreenState extends State<LoadMoreButtonScreen> {
...
// Check states for button
if (query.state.hasNextPage && !query.state.isFetchingNextPage) {
      ...
      children: [
        Expanded(
          child: ElevatedButton.icon(
            ...
            icon: _state.isFetchingNextPage
                ? const SizedBox(
                    width: 16,
                    height: 16,
            ...
            label:
                Text(_state.pages.isEmpty ? 'Load Posts' : 'Load More Posts'),
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Click "Load Posts" to fetch the first page',
                style: TextStyle(
                  color: Theme.of(context).colorScheme.onSurfaceVariant,
                ),
        ...
        child: Center(
          child: Row(
            ...
            children: [
              ...
              const SizedBox(width: 8),
              Text(
                'Click "Load More Posts" button above',
                style: TextStyle(
                  color: Theme.of(context).colorScheme.onSurfaceVariant,
                ),
              ),
