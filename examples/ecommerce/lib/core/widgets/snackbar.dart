      ...
      snackBar = SnackBar(
        ...
        content: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(top: BorderSide(color: CColor.weak), bottom: BorderSide(color: CColor.weak)),
          ),
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                if (withIcon == true) Icon(leadingIcon ?? CustomIcons.sound, color: Colors.white),
                    ...
                    children: [
                      ...
                      if (closable == true)
                        InkWell(
                          ...
                          child: const Icon(CustomIcons.close, color: Colors.white),
                        ),
                    ],
                  ),
                ),
      ...
      snackBar = SnackBar(
        ...
        content: Container(
          ...
          decoration: const BoxDecoration(
            ...
            border: Border(top: BorderSide(color: Color(0xFFFFF3E9)), bottom: BorderSide(color: Color(0xFFFFF3E9))),
          ),
          child: Padding(
            padding: const EdgeInsets.all(12),
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                if (withIcon == true) Icon(leadingIcon ?? CustomIcons.sound, color: CColor.warning),
                if (withIcon == true) 8.horizontalSpace,
                Expanded(
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      ...
                      if (closable == true)
                        InkWell(
                          ...
                          child: Icon(CustomIcons.close, color: CColor.warning),
                        ),
                    ],
                  ),
                ),
      ...
      snackBar = SnackBar(
        ...
        content: Container(
          ...
          decoration: const BoxDecoration(
            ...
            border: Border(top: BorderSide(color: Color(0xFFBCD8FF)), bottom: BorderSide(color: Color(0xFFBCD8FF))),
          ),
          child: Padding(
            padding: const EdgeInsets.all(12),
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                if (withIcon == true) Icon(leadingIcon ?? CustomIcons.sound, color: CColor.info),
                if (withIcon == true) 8.horizontalSpace,
                Expanded(
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      ...
                      if (closable == true)
                        InkWell(
                          ...
                          child: Icon(CustomIcons.close, color: CColor.info),
                        ),
                    ],
                  ),
                ),
